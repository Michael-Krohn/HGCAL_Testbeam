...
def hist_axis(THStack *hist, TH1D *hist_compare):
...
def hist_axis(TH1D *hist, TH1D *hist_compare):
...
def hist_axis_twoplots(TH1D *hist, TH1D *hist_compare):
...
def hist_axis(TGraph *hist, TGraph *hist_compare):
